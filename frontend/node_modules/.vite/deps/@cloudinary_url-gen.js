import {
  ...
  actions_exports
<<<<<<< HEAD
} from "./chunk-CRRXSNNK.js";
=======
} from "./chunk-FHV5EVUH.js";
>>>>>>> a429de3ff68c2da527b1b6df4e5edf185d79756d
import {
  __export
...
var withCamelCaseKeys2 = function(source) {
  return convertKeys(source, camelCase2);
};
var camelCase2 = function(source) {
  let words = source.match(reWords2);
...
var Param = class {
   ...
   * @ignore
   */
  constructor(name, shortName, process2 = identity2) {
    this.name = name;
...
var ArrayParam = class extends Param {
   ...
   * @ignore
   */
  constructor(name, shortName, sep = ".", process2 = void 0) {
    super(name, shortName, process2);
    this.sep = sep;
  }
  serialize() {
...
var TransformationParam = class extends Param {
   ...
   * @ignore
   */
  constructor(name, shortName = "t", sep = ".", process2 = void 0) {
    super(name, shortName, process2);
    this.sep = sep;
  }
  /**
...
var RangeParam = class extends Param {
   ...
   * @ignore
   */
  constructor(name, shortName, process2 = RangeParam.norm_range_value) {
    super(name, shortName, process2);
  }
...
var TransformationBase = class {
  ...
  constructor(options) {
    ...
    this.param = (value, name, abbr, defaultValue, process2) => {
      if (process2 == null) {
      ...
      trans[name] = new Param(name, abbr, process2).set(value);
      return this;
    };
    this.rawParam = function(value, name, abbr, defaultValue, process2) {
      process2 = lastArgCallback(arguments);
      trans[name] = new RawParam(name, abbr, process2).set(value);
      return this;
    };
    this.rangeParam = function(value, name, abbr, defaultValue, process2) {
      process2 = lastArgCallback(arguments);
      trans[name] = new RangeParam(name, abbr, process2).set(value);
      return this;
    };
    this.arrayParam = function(value, name, abbr, sep = ":", defaultValue = [], process2 = void 0) {
      process2 = lastArgCallback(arguments);
      trans[name] = new ArrayParam(name, abbr, sep, process2).set(value);
      return this;
    };
    this.transformationParam = function(value, name, abbr, sep = ".", defaultValue = void 0, process2 = void 0) {
      process2 = lastArgCallback(arguments);
      trans[name] = new TransformationParam(name, abbr, sep, process2).set(value);
      return this;
    };
  ...
  static isValidParamName(name) {
    return methods2.indexOf(camelCase2(name)) >= 0;
  }
  /**
...
function processVar(varArray) {
  ...
  if (Array.isArray(varArray)) {
    ...
    for (j = 0, len = varArray.length; j < len; j++) {
      [name, v] = varArray[j];
      results.push(`${name}_${expression_default2.normalize(v)}`);
    }
    return results;
  } else {
    return varArray;
...
function processCustomFunction3({ function_type, source }) {
...
function generateTransformationString2(transformationOptions) {
  ...
  const variables = Object.entries(transformationOptions).filter(([key, value]) => key.startsWith("$")).map(([key, value]) => {
    ...
    // @ts-ignore
    (transformationOptions.variables || []).map(([name, value]) => `${name}_${legacyNormalizeExpression2(value)}`)
  ).join(",");
...
function finalize_source2(source, format, url_suffix) {
  let source_to_sign;
  source = source.replace(/([^:])\/\//g, "$1/");
  if (source.match(/^https?:\//i)) {
    source = smartEscape2(source);
...
function unsigned_url_prefix2(source, cloud_name, private_cdn, cdn_subdomain, secure_cdn_subdomain, cname, secure, secure_distribution) {
  let prefix;
